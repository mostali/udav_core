...
//		X.exit(c1.equals(c2));
	...
	@SneakyThrows
	public static Pare<String, Path> checkSecureParentPathAndGet(Path parent, String userPath, Boolean isFileOrDirOrAny, boolean... RETURN) {
