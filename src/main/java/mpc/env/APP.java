...
//		return Env.RPA.resolve("gndd.sqlite");
	...
	public static NT getNtOfAppName(NT... defRq) {
	...
	public static class PROP {
		...
		public static String getAppHost(String... defRq) {
			String appName = sysProp(APP_HOST);
			return appName != null ? appName : AP.get(null, APP_HOST, defRq);
		}

		public static String getAppName(String... defRq) {
			String appName = sysProp(APP_NAME);
			return appName != null ? appName : AP.get(null, APP_NAME, defRq);
		}

		public static Integer getPort_ReturnIf80(Integer... defRq) {
			String dPortStr = sysProp("server.port");
		...
		public static String getAppRpa(String... defRq) {
			String appName = sysProp(Env.APK_RPA);
	...
	public static class LOCATION {
		...
		public static Path getAppDataDirOrNull() {
			String appName0 = PROP.getAppName(null);
			if (appName0 != null) {
